...
Below is a screenshot that shows the user interface of the dApp we will build.
...
Follow the steps below to create a new subfolder:
...
After that, you define several state variables, including:
